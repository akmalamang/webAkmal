    ...
    <div>
      ...
      >
        <div className="flex gap-2  justify-center self-center items-center bg-[#0B2447] px-6 py-1 shadow-md">
          <img src="/public/img/google.png" alt="" className="w-[20px] sm:w-[35px]" />
          <a href=""> Google </a>{' '}
        </div>{' '}
        <div className="flex gap-2 justify-center self-center items-center bg-[#0B2447] px-6 py-1 shadow-md">
          <img src="/public/img/linkedin (2) 1.png" alt="" className="w-[20px] sm:w-[35px]" />
          <a href=""> Linkedin </a>{' '}
        </div>{' '}
        <div className="flex gap-2 justify-center self-center items-center bg-[#0B2447] px-6 py-1 shadow-md">
          <img src="/public/img/meta 1.png" alt="" className="w-[20px] sm:w-[35px]" />
          <a href=""> Meta </a>{' '}
        </div>{' '}
        <div className="flex gap-2 justify-center self-center items-center bg-[#0B2447] px-6 py-1 shadow-md">
          <img src="/public/img/gmail.png" alt="" className="w-[20px] sm:w-[35px]" />
          <a href=""> Gmail </a>{' '}
        </div>{' '}
      </div>{' '}
    </div>
